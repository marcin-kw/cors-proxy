...
// Create request handler with default and given values
exports.createRequestHandler = function createRequestHandler(options) {
  options = options || {};
...
exports.createServer = function createServer(options) {
  var requestHandler = exports.createRequestHandler(options);
  if (options && options.httpsOptions) {
    return require('https').createServer(options.httpsOptions, requestHandler);
  }
